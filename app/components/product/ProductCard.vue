  ...
  <Card class="overflow-hidden hover:shadow-md transition-shadow">
    <div class="relative">
      ...
      <span
        ...
        class="absolute left-3 top-3 bg-yellow-400 text-black text-xs font-bold px-2 py-1 rounded"
      >
    ...
    <CardContent class="p-4">
      ...
      <div class="flex items-center justify-between mt-3">
        <span class="font-bold text-lg text-teal-700">${{ product.price.toFixed(2) }}</span>
